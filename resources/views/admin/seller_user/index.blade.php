@extends('layouts.app',['title'=>"Seller Users"])
@section('breadcrump')
                ...
                <div class="search-result">
                    <div class="search-result-header">
                        ...
                        <button class="delete-search-result"
                                onclick="deletepop40('{!! route('seller_user.deleteSelections') !!}','seluser')">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                                    ...
                                    <th class="search-result-table-th">
                                        <label class="checkbox-parent">
                                            <input type="checkbox" class="checkbox-table sd_all" id="checkParent"
                                                   onclick="sdAll('seluser','{!! $users->pluck('id')->implode(',') !!}','.sd_all','.cs1')">
                                        ...
                                        <td class="search-result-table-td">
                                            <label class="checkbox-parent">
                                                <input type="checkbox" class="checkbox-table cs1 ds{!! $item->id !!}"
                                                       onclick="checkInput('seluser','{!! $item->id !!}','.ds')">
                                                <span class="checkmark"></span>
                                            </label>
                                        </td>
                                            ...
                                            <div class="right-buttons">
                                                <button class="table-buttons"
                                                        onclick="client_update({{$item}}
                                                            ,'{{route('seller_users.update',['seller_user'=>$item->id])}}',false)">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                            <path
                                                ...
                                                <button class="table-buttons"
                                                        onclick="opendeletePOPUP('{!! route('seller_users.destroy',['seller_user'=>$item->id]) !!}')">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                            <path
    ...
    <div class="popup popup-u1">
        ...
        <div class="popup-container">
            <div class="popup-content">
                ...
                <form action="{{route('seller_users.store')}}" method="post" class="foradmin">
                    @csrf
                    ...
                    {{--                        <div class="mobile-select">--}}
                    {{--                            <div class="selectHolder selectThin">--}}
                    {{--                                <select name="role" class="role_input role2_error">--}}
                    {{--                                    <option value="">Role Secin</option>--}}
                    ...
                    {{--                            </div>--}}
                    {{--                        </div>--}}
                    {{--                        <span class="error-title role_error"></span>--}}
                    {{--                    </div>--}}
                    <div class="news-address-content-inputs mb1">
                        <label for="" class="label-class f-size-14-b c-dblack-op-75 mb-12">
                            Password
        ...
        <div class="popup-container">
            <div class="popup-content">
                ...
                <form action="" method="post" class="formClients fr2">
                    ...
                    {{--                    <div class="news-address-content-inputs">--}}
                    {{--                        <label for="" class="f-size-14-b c-dblack-op-75 mb-12">--}}
                    {{--                            Role: <span class="role_value"></span>--}}
                    {{--                        </label>--}}
                    {{--                        <div class="mobile-select">--}}
                    {{--                            <div class="selectHolder selectThin">--}}
                    {{--                                <select name="role" class="role_input role2_error">--}}
