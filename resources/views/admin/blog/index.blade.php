    ...
    <div class="top-section b-black">
        <div class="container">
            <div class="top-section-inner">
                ...
                <a class="button-blue f-size-14 c-white bradius-4  b-blue" href="{{route('blogs.create')}}">
    ...
    <div class="homepage-content b-white-1">
                ...
                <div class="search-result">
                    <div class="search-result-header">
                        ...
                        <button class="delete-search-result"
                                onclick="deletepop40('{!! route('blog.deleteSelections') !!}','blog')">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                                    ...
                                    <th class="search-result-table-th">
                                        <label class="checkbox-parent">
                                            <input type="checkbox" class="checkbox-table sd_all" id="checkParent"
                                                   onclick="sdAll('blog','{!! $blogs->pluck('id')->implode(',') !!}','.sd_all','.cs1')">
                                        ...
                                        <td class="search-result-table-td">
                                            <label class="checkbox-parent">
                                                <input type="checkbox" class="checkbox-table cs1 ds{!! $item->id !!}"
                                                       onclick="checkInput('blog','{!! $item->id !!}','.ds')">
                                                <span class="checkmark"></span>
                                            </label>
                                        </td>
                                        <td>{{$item->title}}</td>
                                        <td>{{$item->url}}</td>
                                        <td><img src="{{ asset('/uploads/blogs/'.$item->thumb_nail)}}"
                                                 style="width: 200px;height: 200px"
                                                 alt="Main image"></td>
                                        <td>
                                            <form action="{{route('update_blog_visibility',['blog'=>$item->id])}}"
                                                  method="post">
                                                @csrf
                                                @method('PUT')
                                                @if($item->active)
                                        ...
                                        <td class="right-button-parent">
                                            <div class="right-buttons">
                                                ...
                                                <button class="table-buttons"
                                                        onclick="opendeletePOPUP('{!! route('blogs.destroy',['blog'=>$item->id]) !!}')">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                            <path
        ...
        <div class="container">
            <div class="page-options">
                ...
                {{$blogs->appends(request()->except('page'))->links('partials.simple-pagination')}}
            </div>
        </div>
    </div>
@endsection
