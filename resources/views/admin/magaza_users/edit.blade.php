...
@section('content')
    <div class="add-product-page b-white-1">
        <div class="container">
            ...
            @endisset
            <form action="{{route('magazas.update',['magaza' => $magaza->id])}}" method="post"
                  enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <input type="hidden" name="id" value="{{$magaza->id}}">
                <div class="row">
                    <div class="xl-2">
                    </div>
                    <input type="hidden" name="user_id" value="{{$magaza_user->id}}">
                    <div class="xl-9">
                        <div class="new-address-content bradius-8 b-white">
                            ...
                            <div class="new-address-content-body">
                                <div class="new-address-content-input-groups">
                                    <div class="news-address-content-inputs">
                                        ...
                                        <input type="text" class="input-class" name="full_name"
                                               value="{{old('full_name',$magaza->full_name)}}">
                                    </div>
                                </div>
                                <div class="new-address-content-input-groups">
                                    <div class="news-address-content-inputs">
                                        ...
                                        <input type="text" class="input-class" name="username"
                                               value="{{old('email',$magaza_user->email)}}">
                                    </div>
                                </div>
                                <div class="new-address-content-input-groups">
                                    <div class="news-address-content-inputs">
                                        ...
                                        <input type="password" class="input-class" name="password_other"
                                               value="">
                                    </div>
                                </div>
                                <div class="new-address-content-input-groups">
                                        ...
                                        <select name="category_id" class="input-class">
                                            ...
                                            @foreach($category as $item)
                                                <option value="{{$item->id}}"
                                                        @if($magaza->category)  @if($item->id == $magaza->category->id) selected @endif @endif>{!! $item->name !!}</option>
                                                @if(count($item->children2))
                                                    @include('admin.magaza_users.child_option_edit',['items' => $item->children2,'prefix'=>'&nbsp;&nbsp;'])
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                {{--                                        </label>--}}
                                {{--                                        <input type="text" class="input-class" name="username"--}}
                                {{--                                               value="{{old('username',$magaza->userdetail->email)}}">--}}
                                {{--                                    </div>--}}
                                {{--                                </div>--}}
                                {{--                                <div class="new-address-content-input-groups">--}}
                                {{--                                    <div class="news-address-content-inputs">--}}
                                                ...
                                                <div class="checkboxes">
                                                    <div class="check">
                                                        <input type="checkbox" name="active" id="b"
                                                               @if(old('active',$magaza->active)) checked @endif>
                                                        <label for="b"></label>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="new-address-content-input-groups">
                                    <div class="news-address-content-inputs">
                                        ...
                                        <textarea class="mytextarea"
                                                  name="about">{!! old('about',$magaza->about) !!}</textarea>
                                    </div>
                                </div>
                            ...
                            <img src="{{asset('/uploads/magazas/'.$magaza->thumb_nail)}}" alt="">
                            <img src="{{asset('/uploads/magazas/'.$magaza->logo)}}" alt="">
                        </div>
                    </div>
                </div>
            </form>
