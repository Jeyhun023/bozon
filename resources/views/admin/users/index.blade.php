                ...
                <div class="search-result">
                    <div class="search-result-header">
                        ...
                        <button class="delete-search-result"
                                onclick="deletepop40('{!! route('admin.deleteSelections') !!}','admin')">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                                    ...
                                    <th class="search-result-table-th">
                                        <label class="checkbox-parent">
                                            <input type="checkbox" class="checkbox-table sd_all" id="checkParent"
                                                   onclick="sdAll('admin','{!! $users->pluck('id')->implode(',') !!}','.sd_all','.cs1')">
                                        ...
                                        <td class="search-result-table-td">
                                            <label class="checkbox-parent">
                                                <input type="checkbox" class="checkbox-table cs1 ds{!! $item->id !!}"
                                                       onclick="checkInput('admin','{!! $item->id !!}','.ds')">
                                                <span class="checkmark"></span>
                                            </label>
                                        </td>
                                            ...
                                            <div class="right-buttons">
                                                <button class="table-buttons"
                                                        onclick="client_update({{$item}}
                                                            ,'{{route('admin_users.update',['admin_user'=>$item->id])}}','{!!  $item->roles[0]->name!!}')">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                            <path
                                                ...
                                                <button class="table-buttons"
                                                        onclick="opendeletePOPUP('{!! route('admin_users.destroy',['admin_user'=>$item->id]) !!}')">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                            <path
    ...
    <div class="popup popup-u1">
        ...
        <div class="popup-container">
            <div class="popup-content">
                ...
                <form action="{{route('admin_users.store')}}" method="post" class="foradmin">
                    @csrf
