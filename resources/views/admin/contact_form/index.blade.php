@extends('layouts.app',['title'=>"Mektublar"])
@section('breadcrump')
                ...
                <div class="search-result">
                    <div class="search-result-header">
                        ...
                        <button class="delete-search-result"
                                onclick="deletepop40('{!! route('con.deleteSelections') !!}','con')">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                                    ...
                                    <th class="search-result-table-th">
                                        <label class="checkbox-parent">
                                            <input type="checkbox" class="checkbox-table sd_all" id="checkParent"
                                                   onclick="sdAll('con','{!! $contact->pluck('id')->implode(',') !!}','.sd_all','.cs1')">
                                        ...
                                        <td class="search-result-table-td">
                                            <label class="checkbox-parent">
                                                <input type="checkbox" class="checkbox-table cs1 ds{!! $item->id !!}"
                                                       onclick="checkInput('con','{!! $item->id !!}','.ds')">
                                                <span class="checkmark"></span>
                                            </label>
                                        </td>
                                        ...
                                        <td class="right-button-parent">
                                            <div class="right-buttons">
                                                <button class="table-buttons"
                                                        onclick="opendeletePOPUP('{!! route('con.destroy',['con'=>$item->id]) !!}')">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                            <path
