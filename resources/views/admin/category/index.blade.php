    ...
    <div class="top-section b-black">
        <div class="container">
            <div class="top-section-inner">
                ...
                <a class="button-blue f-size-14 c-white bradius-4  b-blue" href="{{route('category.create')}}">
...
{{--                                {{$category->total()}} nəticə--}}
                            </span>
                        <button class="delete-search-result"
                                onclick="deletepop40('{!! route('category.deleteSelections') !!}','category',true)">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                            ...
                            <table class="search-result-table-overflow search-result-table"
                                    ...
                                    <th class="search-result-table-th">
                                        <label class="checkbox-parent">
                                            <input type="checkbox" class="checkbox-table sd_all" id="checkParent"
                                                   onclick="sdAll('category','{!! $category->pluck('id')->implode(',') !!}','.sd_all','.cs1')">
                                ...
                                @foreach($category as $item)
                                    ...
                                    @if(count($item->children))
                                        @include('admin.category.child',['items' => $item->children,'prefix'=>'&nbsp;&nbsp;&nbsp;&nbsp;'])
                                    @endif
                                @endforeach
                            </table>
                        </div>
        ...
        {{--                    </div>--}}
        {{--                </div>--}}
        {{--                {{$category->appends(request()->except('page'))->links('partials.simple-pagination')}}--}}
        {{--            </div>--}}
        {{--        </div>--}}
    </div>
@endsection
