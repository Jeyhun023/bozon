                            ...
                            <div class="new-address-content-body">
                                        ...
                                        <select name="parent_id" class="input-class">
                                            ...
                                            @foreach($category as $item)
                                                <option value="{{$item->id}}"
                                                        @if($item->id == $cat->parent_id) selected @endif>{!! $item->name !!}</option>
                                                @if(count($item->children2))
                                                    @include('admin.category.child_option_edit',['items' => $item->children2,'prefix'=>'&nbsp;&nbsp;'])
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="new-address-content-input-groups">
                                    <div class="news-address-content-inputs">
                                        ...
                                        <input type="number" class="input-class" name="sort"
                                               value="{{old('sort',$cat->sort)}}">
                                    </div>
                                </div>
                                <div class="new-address-content-input-groups">
                                    <div class="news-address-content-inputs">
                                ...
                                <div class="new-address-content-input-groups">
                                    <div class="news-address-content-inputs">
                                        ...
                                        <textarea name="meta_desc" cols="30"
                                                  rows="10">{!! old('meta_desc',$cat->meta_desc) !!}</textarea>
                                    </div>
                                </div>
                                <div class="new-address-content-input-groups">
                                    <div class="news-address-content-inputs">
